...
require_relative './lib/menu_options/main_help_option'
require_relative './lib/menu_options/log_help_option'
...
require_relative './app/view/table/main_menu_table'
require_relative './app/view/table/log_menu_table'
