...
require_relative './app/repositories/car_repository'
require_relative './app/repositories/user_repository'
require_relative './app/repositories/search_repository'
...
require_relative './app/view/table/user_searches_table'
